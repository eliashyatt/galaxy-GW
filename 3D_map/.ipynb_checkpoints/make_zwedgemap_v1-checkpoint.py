...
# Usage example: python make_zwedgemap_v1.py --map Results/cumulative_reduced3Dmap-8_set_1.npz --distance_step 200 --verbose --phi 60
...
def plot3Dmap(filename):
	...
	plt.savefig('zwedge_3Dlowres-'+str(nside) +'-'+str(args.phi).replace('.','d')+'deg'+'_set_'+ set_name+'.png')
	plt.close()
