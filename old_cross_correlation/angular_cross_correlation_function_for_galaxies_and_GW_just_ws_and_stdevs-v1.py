...
print(deg_or_rad)
print(type(deg_or_rad))
print(GW_df_full['ra'].dtype)
...
print(type(GW_df_full['ra']))
#converting ra and dec to deg
if deg_or_rad == 'rad':
    #GW_df_full['ra'] = pd.to_numeric(GW_df_full['ra'], errors='coerce')
    #print(GW_df_full['ra'].dtype)
    #print(GW_df_full['ra'].head())
    GW_df_full['RA_deg'] = GW_df_full['ra'] * 180 / np.pi
    
    #GW_df_full['Dec_deg'] = pd.to_numeric(GW_df_full['dec'], errors='coerce')
    GW_df_full['Dec_deg'] = (GW_df_full['dec'] * 180 / np.pi)
    GW_df_full['luminosity distance'] = GW_df_full['luminosity_distance']
